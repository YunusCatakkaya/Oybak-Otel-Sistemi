 ...
 * @author ahmet
 */
public class BakımSebebiPopupGUI extends javax.swing.JDialog {
     ...
     */
    public BakımSebebiPopupGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                BakımSebebiPopupGUI dialog = new BakımSebebiPopupGUI(new javax.swing.JFrame(), true);
